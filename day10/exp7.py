...
def main():
    ...
    for i in range(0,rowNum3):
        ...
        for j in range(1,rowNum4):
            b= int(sheet4.cell_value(j, 0))
            c= sheet4.cell_value(j, 1)
            if b == a:
                #print(a,c)     
                sheet1.write(i+1, 0, i+1,set_stlye('Times New Roman', 220, True))
                sheet1.write(i+1, 1, a,set_stlye('Times New Roman', 220, True))
                sheet1.write(i+1, 2, c,set_stlye('Times New Roman', 220, True))
                break
            if j== rowNum1-1:
                print(a)
                sheet1.write(i+1, 0, i,set_stlye('Times New Roman', 220, True))
                sheet1.write(i+1, 1, a,set_stlye('Times New Roman', 220, True))
                print('\n')
